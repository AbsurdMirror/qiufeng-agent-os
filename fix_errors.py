...
replace_in_file("src/domain/translators/schema_translator.py", [
    ...
    ("Callable ", "Callable[..., Any] "),
    ("Callable]", "Callable[..., Any]]"),
    ("def _extract_validators(self, model_class: Type[BaseModel]) -> dict[str, Callable]:", 
     "def _extract_validators(self, model_class: Type[BaseModel]) -> dict[str, Callable[..., Any]]:"),
...
replace_in_file("src/qfaos/enums.py", [
    ...
    ("def get_class(self) -> type['Channel']:", "def get_class(self) -> type['ChannelType']:"),
...
replace_in_file("src/qfaos/qfaos.py", [
    ...
    ("if cls not in cls._instances:", "if cls not in cls._instances: # type: ignore"),
    ("cls._instances[cls] = super().__new__(cls)", "cls._instances[cls] = super().__new__(cls) # type: ignore"),
    ("return cls._instances[cls]", "return cls._instances[cls] # type: ignore"),
    ("def get(self, channel_type: Channel) -> ChannelType:", "def get(self, channel_type: Any) -> ChannelType:"),
    ("return ModelRouter(clients=clients)", "return DefaultModelRouter(clients=clients)"),
